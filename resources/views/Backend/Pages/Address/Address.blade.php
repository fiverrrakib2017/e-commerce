...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="{{route('admin.address.country.index')}}">Country</a>
          <span class="breadcrumb-item active">All Address</span>
        </nav>
      </div><!-- br-pageheader -->
  ...
  <div class="table-wrapper">
    <div class="card">
      <div class="card-header">
        <button  type="button" class="btn btn btn-success"  data-toggle="modal" data-target="#addModal">Add New Address</a>
      </div>
      <div class="card-body">
...
<div id="deleteModal" class="modal fade">
    <div class="modal-dialog modal-dialog-top" role="document">
        ...
        <div class="modal-body tx-center pd-y-20 pd-x-20">
            <form action="{{route('admin.address.delete')}}" method="post" enctype="multipart/form-data">
                @csrf
...
<div id="addModal" class="modal fade effect-scale">
        <div class="modal-dialog modal-lg modal-dialog-top mt-4" role="document">
            ...
            <div class="modal-header pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Add State</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="form-layout form-layout-4">
                     ...
                     <div class="row mb-4">
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                          <select type="text" name="city_id" class="form-control"  required>
                    ...
                    <div class="row mb-4">
                        <label class="col-sm-3 form-control-label">Street Address: <span class="tx-danger">*</span></label>
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                        <textarea type="text" name="street_address" class="form-control" placeholder="Enter Street Address " required></textarea>
                        </div>
                    </div><!-- row -->

                    <div class="row mb-4">
                        <label class="col-sm-3 form-control-label">Postal Code: <span class="tx-danger">*</span></label>
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<!----- Edit Modal ------->
  <div id="editModal" class="modal fade effect-scale">
        <div class="modal-dialog modal-lg modal-dialog-top mt-4" role="document">
            <div class="modal-content tx-size-sm">
            <div class="modal-header pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Update State</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      var table=$("#datatable1").DataTable({
        ...
        ajax: "{{ route('admin.address.all_data') }}",
        language: {
        ...
        "columns":[
          ...
          {
            "data":"city.state.country.country_name"
          },
          {
      ...
      $.ajax({
          ...
          success: function (response) {
              if (response.success) {
                ...
                $('#editModal select[name="city_id"]').val(response.data.city_id);
                $('#editModal textarea[name="street_address"]').val(response.data.street_address);
