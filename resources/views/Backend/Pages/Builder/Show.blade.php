...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="{{route('admin.landing_page.index')}}">Landing Page</a>
  ...
  <div class="table-wrapper">
    <div class="card">
      <div class="card-header">
        <a href="{{route('admin.landing_page.create')}}" class="btn btn btn-success">Add New Page</a>
      </div>
      <div class="card-body">
...
<div id="deleteModal" class="modal fade">
    <div class="modal-dialog modal-dialog-top" role="document">
        ...
        <div class="modal-body tx-center pd-y-20 pd-x-20">
            <form action="{{route('admin.landing_page.delete')}}" method="post" enctype="multipart/form-data">
                @csrf
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      var table=$("#datatable1").DataTable({
        ...
        ajax: "{{ route('admin.landing_page.get_all_data') }}",
        language: {
        ...
        "columns":[
          ...
          {
            render: function (data, type, row) {
              var viewUrl = "{{ route('admin.landing_page.view', ':id') }}".replace(':id', row.id);
              var editUrl = "{{ route('admin.landing_page.edit', ':id') }}".replace(':id', row.id);
