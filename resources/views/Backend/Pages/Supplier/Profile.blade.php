   ...
   <div class="row">
      <div class="col-sm-12">
         ...
         <div class="profile-user-box card-box bg-custom">
            <div class="row">
               <div class="col-sm-6">
                  <span class="float-left mr-3"><img src="{{asset('Backend/images/supplier/'.$data->profile_image)}}" alt="" class="thumb-lg rounded-circle"></span>
               ...
               <div class="col-sm-6">
                  <div class="text-right">
                     <a href="{{route('admin.supplier.edit',$data->id)}}" class="btn btn-light waves-effect"><i class="mdi mdi-account-settings-variant mr-1"></i> Edit Profile</a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="card-box">
            ...
            <div class="panel-body">
               <div class="text-left">
                  ...
                  <p class="text-muted font-13"><strong>Maritial Status :</strong> <span class="m-l-15">
                     @if (!empty($data->marital_status))
                     {{ $data->marital_status }}
                     @endif
                     </span>
                  </p>
                  <p class="text-muted font-13"><strong>Opening Balance :</strong> <span class="m-l-15">
                     @if (!empty($data->opening_balance))
                     {{ $data->opening_balance }}
                     @endif
                     </span>
                  </p>
                  <p class="text-muted font-13"><strong>Bank Name :</strong> <span class="m-l-15">
                     @if (!empty($data->bank_name))
                     {{ $data->bank_name }}
                     @endif
                     </span>
                  </p>
                  <p class="text-muted font-13"><strong>Bank Account Name :</strong> <span class="m-l-15">
                     @if (!empty($data->bank_acc_name))
                     {{ $data->bank_acc_name }}
                     @endif
                     </span>
                  </p>
                  <p class="text-muted font-13"><strong>Bank Account Number :</strong> <span class="m-l-15">
