...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="{{route('admin.customer.index')}}">Supplier</a>
...
<div class="" style="padding: 0px !important;"> 
   <div class="row">
    ...
    <div class="card">
      ...
      <form method="post" action="{{route('admin.supplier.store')}}" id="productForm" enctype="multipart/form-data">   
        @csrf   
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
