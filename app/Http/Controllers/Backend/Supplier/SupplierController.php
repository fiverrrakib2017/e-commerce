...
class SupplierController extends Controller
{
    ...
    public function get_all_data(Request $request)
    {
        ...
        $coupon = Supplier::when($search, function ($query) use ($search) {
            $query->where('fullname', 'like', "%$search%");
            $query->where('email_address', 'like', "%$search%");
            $query->where('phone_number', 'like', "%$search%");
            $query->where('emergency_contract', 'like', "%$search%");
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('profile_image')) {
            ...
            $image->move(public_path('Backend/images/supplier'), $imageName);
        } else {
            $imageName = '';
        }
    ...
    public function delete(Request $request)
    {
        ...
        if (!empty($object->profile_image)) {
            $imagePath = public_path('Backend/images/supplier/' . $object->profile_image);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('profile_image')) {
            ...
            $request->file('profile_image')->move(public_path('Backend/images/supplier/'), $imageName);
