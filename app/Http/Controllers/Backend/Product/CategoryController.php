...
class CategoryController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $object->save();
         ...
         return redirect()->route('admin.category.index')->with('success', 'Brand added successfully');
    }
    ...
    public function update(Request $request){
        ...
        if ($validator->fails()) {
         ...
         if ($request->hasFile('category_image')) {
            ...
            File::delete(public_path('Backend/images/category/' . $category->category_image));
